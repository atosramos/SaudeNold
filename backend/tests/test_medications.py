...
class TestMedications:
    ...
    def test_get_medications_empty(self, client, api_key):
    ...
    def test_create_medication_success(self, client, api_key):
    ...
    def test_get_medications_after_create(self, client, api_key):
    ...
    def test_update_medication(self, client, api_key):
    ...
    def test_update_medication_not_found(self, client, api_key):
    ...
    def test_delete_medication(self, client, api_key):
    ...
    def test_delete_medication_not_found(self, client, api_key):
    ...
    def test_create_medication_sanitizes_input(self, client, api_key):
